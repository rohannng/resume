\cventry
    ...
    \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Enhanced and supported a message processing app ecosystem comprising of various service-oriented modules spread across multiple technologies. \cventryitemskill{(Java, MQ, Python, T-SQL on Sybase)}}
