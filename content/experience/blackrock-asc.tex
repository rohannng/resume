\cventry
    ...
    {java, python, javascript, perl, unix, sybase, weblogic, jboss7.x, java-ee, spring, hibernate, apache-zookeeper, guava, sharding}% Skills
    {
        ...
        supporting fixed income portfolio managers and back-office business operations respectively.
    \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item { Analyzed, designed and ported legacy C\# file formatting libraries to python. ( Jinja2, Python )}
